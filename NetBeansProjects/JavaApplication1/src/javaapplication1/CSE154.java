 ...
 * @author HP
 */
public class CSE154 extends javax.swing.JFrame {
    ...
    public CSE154() {
        ...
        try {
            ...
            ResultSet rs = c.s.executeQuery("select * from cse154");
...
//                   
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if (jTable1.getSelectedRowCount() == 1) {
            ...
            try {
                JDBCCONN c = new JDBCCONN();
                String query = "update cse154 set title = '" + title + "', supliments = '" + sup + "', note = '" + note + "',done= '" + done + "' where title='" + ttitle + "'";
                System.out.println(query);
                c.s.executeUpdate(query);
//            System.out.println(query);
                JOptionPane.showMessageDialog(this, "Update Successfully..");
                new CSE154().setVisible(true);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        try {
            JDBCCONN c = new JDBCCONN();
            String query = "delete from cse154 where title= '" + title + "'";
            c.s.executeUpdate(query);
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {                                       
        ...
        try {
            ...
            String query = "insert into cse154 values('" + title + "','" + sup + "','" + note + "','" + done + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE154.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
