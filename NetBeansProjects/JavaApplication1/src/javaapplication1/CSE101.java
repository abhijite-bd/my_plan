...
//        getContentPane().setBackground(Color.WHITE);
        try {
            ...
            s = c.createStatement();
            ResultSet rs = s.executeQuery("select * from cse101");
            int no = 1;
            while (rs.next()) {
...
//                   
    ...
    private void initComponents() {
        ...
        jLabel43.setText("Fundamental of Computer and Computing");
        jLabel43.setOpaque(true);

        searchtitle.setForeground(new java.awt.Color(153, 153, 153));
        searchtitle.setText("Enter course-title");
        searchtitle.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                searchtitleFocusGained(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(209, 209, 209)
                                        .addComponent(searchtitle, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(searchtitle, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnprogressActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprogressActionPerformed
        ...
        try {
            ...
            c = DriverManager.getConnection("jdbc:mysql:///database1", "root", "abhijite");
            s = c.createStatement();
            ResultSet rs1 = s.executeQuery("select count(*) from cse101");
        ...
        try {
            ...
            c = DriverManager.getConnection("jdbc:mysql:///database1", "root", "abhijite");
            s = c.createStatement();
            ResultSet rs1 = s.executeQuery("select count(*) from cse101 where done=1");
        ...
        JFreeChart pieChart = ChartFactory.createPieChart("Course Progress", pieDataset, true, true, false);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            if (value == "ALL") {
                jLabel5.setText("All Topics");
                rs = s.executeQuery("select * from cse101");
            } else if (value == "COMPLETE") {
                jLabel5.setText("Completed Topics");
                rs = s.executeQuery("select * from cse101 where done=1");
            } else {
                jLabel5.setText("Incompleted Topics");
                rs = s.executeQuery("select * from cse101 where done=0");
            }
            int no = 1;
            while (rs.next()) {
                String title = rs.getString("title");
...
//            System.out.println(query);
    ...
    private void searchtitleFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchtitleFocusGained
        if (searchtitle.getText().equals("Enter course-title")) {
            searchtitle.setText("");
            searchtitle.setForeground(Color.BLACK);
        }
    }//GEN-LAST:event_searchtitleFocusGained
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            c = DriverManager.getConnection("jdbc:mysql:///database1", "root", "abhijite");
            s = c.createStatement();
            jLabel5.setText("Search Topics ");
            ResultSet rs = s.executeQuery("SELECT * FROM cse101 WHERE title LIKE '%" + searchtitle.getText() + "%'");
             int no = 1;
            while (rs.next()) {
                String title = rs.getString("title");
                String sup = rs.getString("supliments");
