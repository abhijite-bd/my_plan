 ...
 * @author HP
 */
public class CSE102 extends javax.swing.JFrame {
   ...
   String ttitle;
    public CSE102() {
        ...
        try {
            ...
            ResultSet rs = c.s.executeQuery("select * from cse102");
...
//                   
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        try {
            ...
            String query = "insert into cse102 values('" + title + "','" + sup + "','" + note + "','" + done + "')";
            conn.s.executeUpdate(query);
            JOptionPane.showMessageDialog(null, "Added Successfully");
            new CSE102().setVisible(true);
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        try {
            JDBCCONN c = new JDBCCONN();
            String query = "delete from cse102 where title= '" + title + "'";
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        if (jTable1.getSelectedRowCount() == 1) {
            ...
            try {
                JDBCCONN c = new JDBCCONN();
                String query = "update cse102 set title = '" + title + "', supliments = '" + sup + "', note = '" + note + "',done= '" + done + "' where title='" + ttitle + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CSE102.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
